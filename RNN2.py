...
with open('SH.csv', encoding='utf-8') as f:
...
class RNN(object):
    ...
    def forwardPropagation(self, X):
        ...
        for t in np.arange(T):
            ...
            out_t[t] = np.max(self.W2.dot(state_t[t]))
    ...
    def SGD_Train(self, model, X_train, y_train, learning_rate=0.05, n_epochs=100, evaluate_loss_steps=5):
